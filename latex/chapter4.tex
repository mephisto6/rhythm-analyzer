...
%----------------------------------------------------------------------------
\section{NEXUS fájlok generálása}
%----------------------------------------------------------------------------

Az elkészült szoftver rendelkezik azzal a funkcióval, hogy speciális, úgynevezett NEXUS fájlokat generáljon, melyet a következõ fejezetben ismeretett SplitsTree nevû alkalmazás kíván bemenetként használni. Egy ilyen fájlra láthatunk példát az \ref{app:nexus}. számú függelékben.
