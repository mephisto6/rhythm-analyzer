...
A \ref{list:kotta}-es fájlban egy ilyen speciálisan kódolt kottát láthatunk. Az elsõ eleme a fájlnak az ütemek hosszát határozza meg. Az ütemek között (az igazi kottához hasonlóan) függõleges vonal ($|$) található, a kottában is szereplõ gerendákat nyitó és záró szögletes zárójel ($[$ és $]$) jelöli, de ezek számunkra nem hordoznak lényeges információt. 
...
A szomszédos elemekhez tartozó arányok az intervallumok hosszait reprezentáló vektorból számíthatók az szomszédos elemek hányadosának sorba vételével:
\[ \left( \begin{array}{cccccccccccc}
